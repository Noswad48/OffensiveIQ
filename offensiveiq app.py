...
def _check_password():
    ...
    st.markdown("### 🔒 OffensiveIQ Access")
    st.error("We couldn't verify your access. Please launch OffensiveIQ from your Coach's Cut account instead of visiting this link directly.")
    st.markdown("[Go to Coach's Cut](https://www.coachscut.com)")
    return False
